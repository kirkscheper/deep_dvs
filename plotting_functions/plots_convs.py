...
checker_100_05 = np.genfromtxt("../results_final/experiment_convs/x05_1000_100_checker.csv", delimiter=",")
checker_100_10 = np.genfromtxt("../results_final/experiment_convs/x1_1000_100_checker.csv", delimiter=",")
checker_100_20 = np.genfromtxt("../results_final/experiment_convs/x2_1000_100_checker.csv", delimiter=",")
...
axarr[0,0].set_title(r'$0.5$x')
axarr[0,1].set_title(r'$1.0$x')
axarr[0,2].set_title(r'$2.0$x')
axarr[0,0].grid(grid)
axarr[0,1].grid(grid)
axarr[1,0].grid(grid)
axarr[1,1].grid(grid)
...
plt.tight_layout()
#plt.savefig('/home/fedepare/Preliminary Thesis Report/Include/images/convs.eps', bbox_extra_artists=(lgd,), bbox_inches='tight')
