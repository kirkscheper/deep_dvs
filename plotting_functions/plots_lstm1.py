...
checker_100_05 = np.genfromtxt("../results_final/experiment_lstm/yesyes_1000_100_road.csv", delimiter=",")
checker_100_10 = np.genfromtxt("../results_final/experiment_lstm/yesyes_1000_100_grass.csv", delimiter=",")
checker_100_20 = np.genfromtxt("../results_final/experiment_lstm/yesyes_1000_100_checker.csv", delimiter=",")
...
plt.tight_layout()
plt.savefig('/home/fedepare/Preliminary Thesis Report/Include/images/lstm01.eps', bbox_extra_artists=(lgd,), bbox_inches='tight')
