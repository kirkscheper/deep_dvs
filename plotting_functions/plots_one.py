...
circle_050 = np.genfromtxt("../results_final/experiment_oneimage/2_100_road.csv", delimiter=",")
circle_100 = np.genfromtxt("../results_final/experiment_oneimage/100_grass.csv", delimiter=",")
circle_150 = np.genfromtxt("../results_final/experiment_oneimage/100_checker.csv", delimiter=",")
...
axarr[0,0].set_title(r'Set 3')
axarr[0,1].set_title(r'Set 4')
axarr[0,2].set_title(r'Set 5')
axarr[0,0].grid(grid)
axarr[0,1].grid(grid)
axarr[1,0].grid(grid)
axarr[1,1].grid(grid)
...
plt.tight_layout()
#plt.savefig('/home/fedepare/Preliminary Thesis Report/Include/images/si_format.eps', bbox_extra_artists=(lgd,), bbox_inches='tight')
