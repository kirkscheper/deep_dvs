...
circle_050 = np.genfromtxt("../results_final/experiment_variance/050_grass.csv", delimiter=",")
circle_100 = np.genfromtxt("../results_final/experiment_variance/100_grass.csv", delimiter=",")
circle_150 = np.genfromtxt("../results_final/experiment_variance/150_grass.csv", delimiter=",")
...
plt.tight_layout()
#plt.savefig('/home/fedepare/Preliminary Thesis Report/Include/images/road_test.eps', bbox_extra_artists=(lgd,), bbox_inches='tight')
